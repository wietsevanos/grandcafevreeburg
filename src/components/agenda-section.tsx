          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="p-8 md:p-12 lg:p-14 flex flex-col justify-center">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="btn-primary w-full min-w-0 h-12 px-1.5 sm:px-5 text-[0.65rem] sm:text-[0.9rem] whitespace-nowrap tracking-tight"
                >
                  Reserveer een tafel
                </button>
                <button
                  type="button"
                  onClick={() => setFlyer(featured.ev)}
                  className="btn-ghost w-full min-w-0 h-12 px-1.5 sm:px-5 text-[0.65rem] sm:text-[0.9rem] whitespace-nowrap tracking-tight"
                >
                  Bekijk flyer
                </button>
              </div>
