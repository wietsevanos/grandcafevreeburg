  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-cream">
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[min(520px,85vw)] md:max-w-[640px] h-auto max-h-[55vh] md:max-h-[60vh] object-contain opacity-15 pointer-events-none select-none"
      />
